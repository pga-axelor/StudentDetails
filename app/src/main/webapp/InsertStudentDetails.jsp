...
<body>
	<center>
		<h1>Student Details Insertion</h1>
		<br> <br>
		<form name="StduentList"
			action="<%=request.getContextPath()%>/StudentDetails/insert"
			method="POST">
			<table>
				<tr>
					<th colspan="2"><h2 style="margin-left: 29%;">Insert data</h2></th>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="sem" name="sem" required></td>
				</tr>
				<tr>
